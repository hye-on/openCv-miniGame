...
file_v = open('time_v.txt', 'r', encoding='UTF8')
head_count = 0
...
while webcam.isOpened():
    ...
    # Drwaing Text on the screen
        ...
        if Distance < 160:
            cv2.putText(frame, "back your step",
                        (50, 80), fonts, 1.0, (RED), 3)
        elif Distance > 210:
            cv2.putText(frame, "front you step",
                        (50, 80), fonts, 1.0, (RED), 3)
    ...
    # 추적 결과 화면 출력
        ...
        if head_count < 1:
            ...
            vs_time = 5000 # 숫자 파일 읽어오고 싶은데, 자꾸 공백 없는데 공백 오류가 남...
            if vs_time > test_time:
                cv2.putText(frame, "YOUR WIN!", (100, 100),
                            fonts, 3, (0, 255, 0), 4)
            if vs_time < test_time:
                cv2.putText(frame, "YOUR LOSE!", (100, 100),
                            fonts, 3, (0, 255, 0), 4)
            if vs_time == test_time:
                cv2.putText(frame, "TIE!", (100, 100),
                            fonts, 3, (0, 255, 0), 4)
